...
function budva_widgets_init()
{
    register_sidebar(array(
        'name' => __('Footer position II', 'budva'),
    ...
    register_sidebar(array(
        'name' => __('Footer position I', 'budva'),
    ...
    register_sidebar(array(
        'name' => __('Footer position III', 'budva'),
    ...
    register_sidebar(array(
        'name' => __('Footer position IV', 'budva'),
...
add_action('widgets_init', 'budva_widgets_init');
